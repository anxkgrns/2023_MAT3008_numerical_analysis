...
float rtbis(float (*func)(float), float x1, float x2, float xacc, int* convergence_speed);
float rtflsp(float (*func)(float), float x1, float x2, float xacc, int* convergence_speed);
float rtnewt(void (*funcd)(float, float *, float *), float x1, float x2,
	float xacc, int* convergence_speed);
float rtsafe(void (*funcd)(float, float *, float *), float x1, float x2,
	float xacc, int* convergence_speed);
float rtsec(float (*func)(float), float x1, float x2, float xacc, int* convergence_speed);
...
float muller(float (*func)(float), float x1, float x2, float xacc, int* convergence_speed);
